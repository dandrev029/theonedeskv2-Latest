<template>
  <div class="relative">
    <label v-if="label" class="block text-sm font-medium leading-5 text-gray-700" :for="id">
      {{ label }}
    </label>
    <div class="mt-1 relative">
      ...
      >
        ...
        <div class="px-3 py-2 border-b border-gray-200" @click.stop>
          <input
            v-model="searchQuery"
            type="text"
        ...
        <ul tabindex="-1" role="listbox" :aria-labelledby="id">
          <li
            ...
            :class="{ 'bg-indigo-50': option.id === modelValue }"
          ...
          <li v-if="filteredOptions.length === 0" class="text-gray-500 py-2 pl-3 pr-9">
            {{ noResultsText }}
          </li>
        </ul>
      </div>
