        ...
        <div :class="{'': showMenu, 'hidden': !showMenu}" class="md:hidden">
            <div class="fixed inset-0 flex z-40">
                ...
                >
                    ...
                    >
                        <div class="absolute inset-0 bg-primary-800 opacity-75"></div>
                    </div>
                </transition>
                <transition
                    ...
                    >
                        <div class="absolute top-0 right-0 -mr-14 p-1">
                            <button
                                ...
                                class="flex items-center justify-center h-12 w-12 rounded-full focus:outline-none focus:bg-primary-700"
                            >
