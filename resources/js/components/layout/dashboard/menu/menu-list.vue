    ...
    <div>
        ...
        <div
            v-if="$store.state.permissions && (
                ...
                $store.state.permissions['App.Http.Controllers.Api.Dashboard.Admin.FaqController'] // Added FaqController permission
            )"
        ...
        <menu-item
            v-if="$store.state.permissions && $store.state.permissions['App.Http.Controllers.Api.Dashboard.Admin.FaqController']"
