    ...
    <div class="ticket-card-body">
      ...
      <div class="text-sm text-gray-500 mb-2">
        ...
        <div v-if="ticket.scheduled_visit_at" class="flex items-center mb-1">
          <svg-vue class="h-4 w-4 mr-1 text-gray-400" icon="font-awesome.calendar-alt-regular"></svg-vue>
    ...
    <div class="ticket-card-footer">
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center">
          <div v-if="ticket.agent" class="flex items-center text-sm text-gray-500">
